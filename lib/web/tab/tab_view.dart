...
class TabView extends ContainerView {
  ...
  static Future<TabView> createTabView(int id, int col, String title, String shortName, List config, [String externalCssPath]) {
    Completer c = new Completer();
    c.complete(new TabView(id, col, title, shortName, config, externalCssPath));
    return c.future;
  }
  ...
  TabView(int id, int col, String title, String shortName, List config, [String externalCssPath]) :
